export function XCronLogo({ size = 200, className = '' }: { size?: number, className?: string }) {
    return (
        <div className={`xcron-logo-wrapper ${className}`} style={{ width: size, height: size }}>
            <svg
                viewBox="0 0 200 200"
            ...
            >
                ...
                {/* ═══ X Star Shape ═══ */}
                <g className="logo-x-star" filter="url(#softGlow)">
                    {/* Top-right spike */}
                    <polygon
                ...
                {/* ═══ Chain Circle ═══ */}
                <g className="logo-chain-circle" filter="url(#neonGlow)">
                    {/* Main circle ring */}
                    <circle
                        cx="100" cy="100" r="40"
                        fill="none"
