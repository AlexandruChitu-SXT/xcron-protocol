            ...
            <div className="page">
                <div className="app-container">
                    ...
                    <div style={{ marginBottom: 20 }}>
                        <TypewriterTitle as="h1" text="Clone-Keys" speed={60} className="text-3xl md:text-4xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-cyan-400 drop-shadow-[0_2px_15px_rgba(34,211,238,0.25)] relative z-10" />
                    ...
                    <div style={{
                        ...
                        <p style={{ marginBottom: 0, fontSize: '0.92rem' }}>
                            <strong style={{ color: 'var(--text-primary)' }}>Benefits:</strong>{' '}
...
function CloneKeyCard({ ck, loading, fundingKey, fundAmount, onRevoke, onStartFund, onCancelFund, onFund, onFundAmountChange }: {
    ...
    const pct = spendLimitBig > BigInt(0)
        ? Number((spentBig * BigInt(100)) / spendLimitBig)
        : 0;
