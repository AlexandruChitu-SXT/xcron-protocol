                        ...
                        <div className={`w-full h-full flex flex-col p-3 rounded-xl bg-black/80 backdrop-blur-xl border border-t-[2px] shadow-lg relative z-10 ${isDeploying ? 'border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.3)]' : 'border-purple-500/50 shadow-[0_0_10px_rgba(168,85,247,0.15)] hover:border-purple-400/80'}`}>
                            <div className="flex justify-between items-center mb-1">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xl font-black text-white leading-none mt-0.5">{Math.floor(ingressStream[Math.max(0, ingressStream.length-1)]).toLocaleString('es-ES', { maximumFractionDigits: 0 })} <span className={`text-[9px] tracking-wider ${isDeploying ? 'text-purple-400' : 'text-purple-400'}`}>TXs</span></span>
                                </div>
                        ...
                        <div className={`w-full h-full flex flex-col p-3 rounded-xl bg-black/80 backdrop-blur-xl border border-t-[2px] shadow-lg relative z-10 ${isDeploying ? 'border-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.3)]' : 'border-cyan-500/50 shadow-[0_0_10px_rgba(6,182,212,0.15)] hover:border-cyan-400/80'}`}>
                            <div className="flex justify-between items-center mb-1">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xl font-black text-white leading-none mt-0.5">{Math.floor(burstStream[Math.max(0, burstStream.length-1)]).toLocaleString('es-ES', { maximumFractionDigits: 0 })} <span className={`text-[9px] tracking-wider ${isDeploying ? 'text-orange-400' : 'text-cyan-400'}`}>TXs</span></span>
                                </div>
