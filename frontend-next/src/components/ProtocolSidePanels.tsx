...
function XwapVitals() {
    ...
    return (
        <div style={{ ...widgetStyle, borderColor: 'rgba(168,85,247,0.2)' }}>
...
function ProtocolBalance({ balance, loading }: { balance: string; loading: boolean }) {
    return (
        <div style={{ ...widgetStyle, borderColor: 'rgba(251,191,36,0.15)' }}>
...
export function RightSidePanel() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            {/* Protocol Status */}
            <div style={{ ...widgetStyle, borderColor: 'rgba(34,197,94,0.12)' }}>
