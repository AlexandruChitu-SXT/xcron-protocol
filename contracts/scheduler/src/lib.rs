    ...
    + common::pausable::PausableModule
{
    ...
    fn init(
        ...
        self.max_tasks_per_round().set(common::constants::MAX_TASKS_PER_ROUND);
    }
    ...
    fn upgrade(&self) {
        ...
        self.max_tasks_per_round().set_if_empty(common::constants::MAX_TASKS_PER_ROUND);
        self.max_reward_per_exec()
